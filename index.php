...
<body>
	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
				...
				<div class="row" style="background-image: url(https://free4kwallpapers.com/uploads/originals/2019/11/04/the-roof-of-my-hostel-wallpaper.jpg); background-attachment: fixed; " >
					<div class="col-md-12">
					
						<h2 class="page-title" style="background-color: aliceblue"><center>User Login </center></h2>
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								...
								<form action="" class="mt" method="post">
									...
									<input type="text" placeholder="Email / Registration Number" name="emailreg" class="form-control mb" required="true"><br>
